  ...
  const data = [
    {
      ...
      content: (
        <div>
          {/* Changed: Added responsive text size classes */}
          <h1 className="text-xl font-semibold md:text-2xl lg:text-3xl mb-2">
            Mumbai to Delhi
          </h1>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            After arriving in Delhi at 11:00 am get transferred inyour
            respective tempo travellers and start your journey to Chandigarh.
            Reach Chandigarh by late afternoon or evening andcheck into your
            hotel, freshen up. Explore localmarkets of Chandigarh sector 17 and
            have your CLUBBING NIGHT in Chandigarh city. Dinner and overnight
            stay in Chandigarh.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          {/* Changed: Changed p to h1 for semantic correctness and added responsive text size classes */}
          <h1 className="mb-2 text-xl font-semibold text-neutral-800 md:text-2xl lg:text-3xl dark:text-neutral-200">
      ...
      content: (
        <div>
          ...
          <p>
            ...
            you can also visit the Atal Tunnel, one of the highest road tunnels
            in the world. Also explore Sissu/Koksar famous for snow activities.
            Enjoy the serene beauty of the snow-covered mountains and the crisp
            mountain air. Dinner and overnight stay in hotel.
          </p>
          <div className="mb-8"></div>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>
            You&apos;ll travel to Kasol, a picturesque village in the Parvati
            Valley, known for its scenic beauty and vibrant culture, enroute
            halt for River Rafting. Spend the day soaking in the tranquility of
            this small village, walking along the Parvati River, and exploring
            the local cafes and markets. Enjoy your stay in camps in Kasol with
            DJ party and bonfire.
          </p>
          <div className="mb-8"></div>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>
            After breakfast, check out from your camps and You will continue
            your sightseeing in Kasol. The village is an ideal spot for
            trekking, visit Manikaran Gurudwara, Kasol Market & chalal bridge.
            After dinner proceed to Dharamshala (overnight journey).
          </p>
          <div className="mb-8"></div>
          <div className="grid grid-cols-2 gap-4">
            <Image
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            ...
            Norbulingka Institute, HPCA stadium & Mcleodganj Market. The
            peaceful ambiance and rich cultural heritage of Dharamshala offer a
      ...
      content: (
        <div>
          ...
          <p>
            ...
            carried to its nightly resting place. After a full day of
            exploration, take an overnight journey back to Delhi.
          </p>
          <div className="mb-8"></div>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Reach Mumbai, where your unforgettable journey comes to an end.</p>
          <div className="mb-8"></div>
          <div className="grid grid-cols-2 gap-4">
            <Image
